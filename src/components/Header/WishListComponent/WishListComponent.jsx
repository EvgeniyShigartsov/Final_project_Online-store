...
import { MODULE_NAME } from '../../../store/wishlist/reducer'
import StyledLiked from './StyledWishListComponent'
import CircleCount from './CircleCount'

const mapStateToProps = (state) => ({wishitstLength: state[MODULE_NAME].wishitstLength})

const WishListComponent = connect(mapStateToProps, null)(({wishitstLength}) => {
  console.log(wishitstLength)
  return (
