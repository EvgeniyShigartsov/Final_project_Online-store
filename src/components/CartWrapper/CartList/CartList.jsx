...
const CartList = connect(
  ...
  return (
    <StyledCartList>
      <StyledButton size="xl" shape="round" onClick={() => addToCart(productID_1, 5)}>Add to cart_1</StyledButton>
      <StyledButton size="xl" shape="round" onClick={() => addToCart(productID_2, 20)}>Add to cart_2</StyledButton>
      <TheadCart />
